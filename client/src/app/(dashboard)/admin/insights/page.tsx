  ...
  return (
    <div className="space-y-16">
      <div className="flex flex-col gap-4">
        <h1 className="text-6xl font-semibold tracking-tighter text-black">Administrator Insights</h1>
        <p className="text-xl text-slate-500">Global categorical analysis and transaction auditing.</p>
      </div>
